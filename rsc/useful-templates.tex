...
\begin{filecontents*}{__useful_templates-\theusefultemplate.tex}
\ifnotfinal{
    This text only appears while the document is a draft,
    and won't be there after you uncomment out the
    \textit{final,} line at the top of \textit{main.tex}.
}
\end{filecontents*}
\@defusefultemplate{Draft-only content}
