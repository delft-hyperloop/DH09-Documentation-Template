% \definedept defines the department. LaTeX keeps track of all the departments defined, and the template uses it to match with the \dept{Sense and Control} in main.tex to output the authors.
...
\definedept{Sense and Control}{Pablo Arellano Benito}

\deptperson{Harald Toth}
\deptperson{Dinu Blanovschi}
\deptperson{Jorian Rennen}
\deptperson{Thijs Geschiere}
\deptperson{Max Guichard}
