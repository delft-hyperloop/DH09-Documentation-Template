% \definedept defines the department. LaTeX keeps track of all the departments defined, and the template uses it to match with the \dept{Thermal} in main.tex to output the authors.
...
\definedept{Thermal}{Rok Štular}

\deptperson{Radek Waga}
\deptperson{Roman Damen}
