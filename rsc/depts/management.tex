% \definedept defines the department. LaTeX keeps track of all the departments defined, and the template uses it to match with the \dept{Management} in main.tex to output the authors.
...
\definedept{Management}{Sophie Loogman}

\deptperson{Angelika Mentzelopoulou}
\deptperson{Daniel Bot}
