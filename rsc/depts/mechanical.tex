% \definedept defines the department. LaTeX keeps track of all the departments defined, and the template uses it to match with the \dept{Mechanical} in main.tex to output the authors.
...
\definedept{Mechanical}{Roman Damen}

\deptperson{David Willemse}
\deptperson{Medhans Agarwal}
