% \definedept defines the department. LaTeX keeps track of all the departments defined, and the template uses it to match with the \dept{Scalability} in main.tex to output the authors.
...
\definedept{Scalability}{Mike Smalbroek}

\deptperson{Simone Hoogendijk}
\deptperson{Oscar de Boer}
\deptperson{Alexander van Haastrecht}
