...
\newcommand\@dorenderusefultemplatestikz{
    ...
    \whiledo{\value{renderusefultemplatestikzcnt}<\value{usefultemplatetikz}}{
        ...
        \addcontentsline{toc-useful-templates}{section}{\@nameuse{usefultemplatetikztitle\therenderusefultemplatestikzcnt}}
        \@codeandoutput{__useful_templates_tikz-\therenderusefultemplatestikzcnt}{useful-templates-tikz-\therenderusefultemplatestikzcnt}{Code listing for \@nameuse{usefultemplatetikztitle\therenderusefultemplatestikzcnt}}
...
\newcommand\@renderusefultemplatestikzfromoutput{
    ...
    \whiledo{\value{renderusefultemplatestikzcnt}<\value{usefultemplatetikz}}{
        ...
        \section*{\@nameuse{usefultemplatetikztitle\therenderusefultemplatestikzcnt}}
        \addcontentsline{toc-useful-templates}{section}{\@nameuse{usefultemplatetikztitle\therenderusefultemplatestikzcnt}}
        \@codeandoutputtikz{__useful_templates_tikz-\therenderusefultemplatestikzcnt}{useful-templates-tikz-\therenderusefultemplatestikzcnt}{Code listing for \@nameuse{usefultemplatetikztitle\therenderusefultemplatestikzcnt}}{\therenderusefultemplatestikzcnt}
        \stepcounter{renderusefultemplatestikzcnt}
    }
}
